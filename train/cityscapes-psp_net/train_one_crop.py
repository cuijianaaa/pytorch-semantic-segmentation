...
def main():
    ...
    #net = PSPNet(num_classes=cityscapes.num_classes, backend='resnet18')
...
#    ])
    ...
    train_joint_transform = joint_transforms.Compose([
        joint_transforms.CenterCrop(712),
...
def train(train_loader, net, criterion, optimizer, curr_epoch, train_args):
    nnn = 0
    min_loss = 100;
    while True:
